...
repl = [
    ...
    # 004 神户 胜/平B：2-1/1-1/2-2（对攻大球覆盖4球）
    ...
    # 010 诺维奇 胜/平B：2-1/2-2/3-1（大球3·4）
    ('{ no: "010", home: "诺维奇", away: "西布罗姆维奇", league: "英冠", lg: "lg-champ",\n          dir: "胜/平（B级）", dc: "dir-windraw", scores: "2-1 / 2-2 / 1-2*", ht: "胜胜/平平/平负*", ou: "总进球 3·4", risk: 4,',
     '{ no: "010", home: "诺维奇", away: "西布罗姆维奇", league: "英冠", lg: "lg-champ",\n          dir: "胜/平（B级）", dc: "dir-windraw", scores: "2-1 / 2-2 / 3-1", ht: "胜胜/平平/胜平", ou: "总进球 3·4", risk: 4,'),
    # 011 奥斯陆 负/平B：1-1/1-2/2-2（挪超高进球覆盖4球）
    ...
    # 014 玛丽港 负C：0-1/1-2/1-1*（2主1反，覆盖3球）
    ('{ no: "014", home: "玛丽港", away: "塞伊奈约基", league: "芬超", lg: "lg-fin",\n          dir: "负（C级）", dc: "dir-drawloss", scores: "0-1 / 1-1* / 1-0*", ht: "负负/平平*/平胜*", ou: "总进球 1·2", risk: 8,',
     '{ no: "014", home: "玛丽港", away: "塞伊奈约基", league: "芬超", lg: "lg-fin",\n          dir: "负（C级）", dc: "dir-drawloss", scores: "0-1 / 1-2 / 1-1*", ht: "平负/负负/平平*", ou: "总进球 1·2", risk: 8,'),
    # 016 谢菲联 胜B：2-1/2-0/3-1（覆盖4球）
    ...
    # 019 阿拉维斯 胜/平B：1-0/1-1/2-1（覆盖3球）
    ...
    # 024 塞维利亚 胜/平B：1-1/2-1/1-0（覆盖3球）
    ...
    # 026 弗鲁米嫩塞 平/负B：0-1/1-1/1-2（覆盖3球）
