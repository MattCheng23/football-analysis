    ...
    predict: {
      matches: [
        ...
        { no: "011", home: "奥斯陆KFUM", away: "利勒斯特罗姆", league: "挪超", lg: "lg-nor",
          ...
          logic: "利勒斯特罗姆第4（16场25分）但近6场联赛2胜4负（刚主场0-2负罗森博格）+进22失20攻强守弱；首回合2-1胜+交锋3连胜；KFUM第12但联赛2连胜状态回暖+进球联赛第2少（12球）+门将E.Ødegaard伤疑" },
        { no: "014", home: "玛丽港", away: "塞伊奈约基", league: "芬超", lg: "lg-fin",
          dir: "负（C级）", dc: "dir-drawloss", scores: "0-2 / 1-2 / 1-1*", ht: "负负/平负/平平*", ou: "总进球 2·3", risk: 8,
          logic: "玛丽港19场5分垫底+近5场0胜1平4负+场均0.5球联赛最差+失41球防守最差 vs 塞伊奈约基第10（近5场1胜1平3负状态一般）；交锋30次玛丽港仅10胜15负+上次0-0，野鸡剧本矩阵" },
        { no: "016", home: "谢菲尔德联", away: "伯明翰", league: "英冠", lg: "lg-champ",
          dir: "胜（B级）", dc: "dir-win", scores: "2-1 / 3-1 / 2-0", ht: "胜胜/负胜/平胜", ou: "总进球 2·3", risk: 3,
          logic: "谢菲联核心中场哈默本周卖考文垂+菲利普斯租借回归仅替补起步+Chong伤疑；伯明翰中场莱昂纳德季前赛伤缺确定+边卫布坎南/莱尔德伤愈恢复期首发存疑+锋线斯坦斯菲尔德近3季41球与普里斯克首发" },
...
/* 全局累计命中率（跨批次） */
const GLOBAL_STATS = {
  dir: "52/73", dirPct: "71.2%",
  score: "34/73", scorePct: "46.6%",
  ht: "49/73", htPct: "67.1%",
  updated: "2026-08-15"
};
